...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5h2gek.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5h2gek.containers.anotherwebservice.com/
...
```
git clone git@github.com:Siraj-Ahamed/container-5h2gek.git
cd container-5h2gek
```
...
```
docker attach container-5h2gek
```
